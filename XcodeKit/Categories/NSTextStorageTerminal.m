...
- (NSRange) rangeOfProperNameBeforeOffset: (unsigned) offset
{
    ...
    while (retval.location-1 >= 0 && [domainCharset characterIsMember: [string characterAtIndex: retval.location-1]]) {
        retval.location--;
        retval.length++;
    }
